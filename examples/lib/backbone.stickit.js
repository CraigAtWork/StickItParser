...
(function (factory) {
  ...
  var applyViewFn = function(view, fn) {
    ...
    //<CRAIG>
//    var closureArguments = arguments;
//    if (fn) {
//      if (_.isArray(fn)) {
//          console.log("handling isArray() case");
//          _.reduce(fn, function(memo, value, index, list) {
//            memo = value.apply(view, _.rest(closureArguments, 2));
//          })
//      } else {
